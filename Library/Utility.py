...
kinematic_chain_human = {"left leg": np.arange(0, 6)*3, 
    "right leg": np.array([0, 6, 7, 8, 9, 10])*3,
    "left arm": np.arange(13, 18)*3, 
    "left hand index": np.arange(17,22)*3,  
    "left hand middle": np.array([17,22,23,24,25])*3,
    "left hand pinky": np.array([17,26,27,28,29])*3, 
    "left hand ring": np.array([17,30,31,32,33])*3,  
    "left hand thumb": np.array([17,34,35,36,37])*3,
    "right arm": np.concatenate(([13], np.arange(41, 45)))*3,
    "right hand index": np.arange(44,49)*3,
    "right hand middle": np.array([44,49,50,51,52])*3,
    "right hand pinky": np.array([44,53,54,55,56])*3,
    "right hand ring": np.array([44,57,58,59,60])*3,
    "right hand thumb": np.array([44,61,62,63,64])*3,
    "spine to neck": np.array([0, 11, 12, 13, 38, 39])*3,
    "head": np.array([39, 40])*3} 

def remove_hands(data):
    joints = np.concatenate((np.arange(0,6*3), # left leg
              np.arange(6*3, 11*3), # right leg
              np.arange(11*3, 13*3), # spine
              np.arange(13*3, 18*3), # left arm
              np.arange(41*3, 45*3), # right arm
              np.arange(38*3, 41*3))) # neck head

    data = data[:, joints]
    return data, np.array([np.arange(0,6), # left leg
                  np.concatenate(([0], np.arange(6, 11))), # right leg
                  np.array([0, 11, 12, 13, 22, 23]), # spine
                  np.arange(13, 18), # left arm
                  np.concatenate(([13],np.arange(18, 22))), # right arm
                  np.array([23, 24]) # neck head
              ])*3, ['red', 'blue', 'black', 'red', 'blue', 'orange']
