...
kinematic_chain = [utility.kinematic_chain_human[joint] for joint in ["left leg","right leg","left arm","right arm","spine to neck","head"]]
colors = ['red', 'blue', 'red', 'red', 'red', 'red', 'red', 'red', 'blue', 'blue', 'blue', 'blue', 'blue', 'blue', 'black', 'orange']
...
if __name__ == '__main__':
    ...
    # input animation
    plot_animation(seq_one_p[0], seq_all[:, indice_velocity_pred], f'input_e{epoch}_orignial', True)
    ...
    # # output animation
    plot_animation(seq_one_p[0], yPred.cpu().detach().numpy()[:, indice_velocity_pred], f'output_e{epoch}_orignial', True)