...
if __name__ == '__main__':
    ...
    Data, _, _ = utility.remove_hands(Data)
    ...
    print("Train on cuda: ", torch.cuda.is_available())
    ...
    for epoch in range(epochs):
        ...
        for i in range(0, sample_count, batch_size):
            ...
            network.train()
            train_batch = LoadBatches(train_indices) # Joe: train batch shape (batch_size, frames*joints*3)
        ...
        # Joe: print('Epoch', epoch+1, loss_history.CumulativeValue())

        #Save Phase Parameters
        print("Saving Parameters for Epoch " + str(epoch + 1))
        network.eval()
