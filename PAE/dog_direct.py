...
if __name__ == '__main__':
    ...
    # input animation
    epoch = 30
    plot_animation(seq_one_p[0], seq_viz, f"input_e{epoch}_direct", truncate)
    
    # build network model
  
    network = torch.load(f"/home/pan/GenerativeMotion_Joe/AI4Animation-master/AI4Animation/SIGGRAPH_2022/PyTorch/PAE/saved_weights/{epoch}_5Channels.pt")
    network.cuda()
    network.eval()
